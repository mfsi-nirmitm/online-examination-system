...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Examination/AdminModule/CoursePage/coursecss.css" />
        <s:head/>
    </head>
    <body>
        ...
        <section>
            <s1><s:a action="viewcourse">View Courses</s:a></s1>
            <s2><s:a action="addcourseaction">Add Course</s:a></s2>
            <s3><s:a action="courselist">Remove Course</s:a></s3>
        </section>
