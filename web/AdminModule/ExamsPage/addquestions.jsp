...
<html>
    ...
    <body>
        ...
        <s:form action="addquesaction" method="post">
            <s:textfield label="Exam" key="subject" />
            <s:textfield label="Question" key="ques" />
            <s:textfield label="Option 1" key="op1" />
            <s:textfield label="Option 2" key="op2" />
            <s:textfield label="Option 3" key="op3" />
            <s:textfield label="Option 4" key="op4" />
